...
class UWSMQ_Core {
	...
	private function define_public_hooks() {
		...
		// Note: pre_wp_mail, phpmailer_init, wp_mail_failed are registered in uwsmq_bootstrap()
		// to ensure they run at plugins_loaded priority 1 (before CF7 and other plugins).
	}
